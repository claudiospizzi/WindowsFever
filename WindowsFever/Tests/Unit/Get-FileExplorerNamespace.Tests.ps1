    ...
    Context 'Default' {
        ...
        BeforeAll {
            ...
            Mock 'Get-ItemProperty' -ModuleName $moduleName -ParameterFilter { $Path -eq 'HKCU:\SOFTWARE\Classes\CLSID\{018D5C66-4533-4307-9B53-224DE2ED1FE6}\DefaultIcon' } {
                [PSCustomObject] @{
                    '(default)' = 'C:\Users\test.user\AppData\Local\Microsoft\OneDrive\OneDrive.exe,0'
                }
            }
        ...
        It 'should return the OneDrive namespace by name' {
            ...
            $namespace.Icon        | Should -Be 'C:\Users\test.user\AppData\Local\Microsoft\OneDrive\OneDrive.exe,0'
